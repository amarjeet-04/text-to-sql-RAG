...
const DEFAULT_DB_SETTINGS = {
  ...
  llm_provider: 'openai',
  api_key: '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',
  model: 'gpt-4o-mini',
  temperature: 0,
  query_timeout: 60,
  view_support: true,
